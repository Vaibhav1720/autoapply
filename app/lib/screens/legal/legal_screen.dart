    ...
    return _PolicyScaffold(
      ...
      sections: const [
        _PolicySection(
          '1. Introduction',
          [
            'AutoApply ("we", "us", or "our") operates autoapplynow.in and the AutoApply web application. This Privacy Policy explains what information we collect, how we use it, and your rights regarding your data.',
            'By using AutoApply you agree to the practices described in this policy. If you do not agree, please discontinue use immediately.',
          ],
        ),
        _PolicySection(
        ...
        _PolicySection(
          ...
          [
            'AutoApply uses browser local storage (not traditional cookies) to persist your authentication token so you remain logged in across sessions. We do not use third-party advertising cookies.',
          ],
          bullets: [
        ...
        _PolicySection(
          ...
          [
            'We use your information exclusively to provide and improve the AutoApply service.',
          ],
          bullets: [
            'Authenticate you and keep your account secure.',
            'Personalise job discovery results using AI matching against your profile.',
            'Auto-fill job application forms via the AutoApply Chrome Extension.',
        ...
        _PolicySection(
          ...
          [
            'AutoApply is intended for users aged 18 and above. We do not knowingly collect data from children under 18. If you believe a child has created an account, please contact us immediately.',
          ],
        ),
        _PolicySection(
          '12. Changes to This Policy',
          [
            'We may update this Privacy Policy from time to time. Material changes will be communicated via in-app notification or email. Continued use of AutoApply after changes constitutes acceptance.',
          ],
        ),
      ],
    );
    ...
    return _PolicyScaffold(
      ...
      sections: const [
        _PolicySection(
          ...
          [
            'By accessing or using AutoApply ("Service") at autoapplynow.in, you agree to be bound by these Terms & Conditions ("Terms"). If you do not agree, you must not use the Service.',
            'These Terms form a legally binding agreement between you and AutoApply. We reserve the right to update them at any time; continued use after updates constitutes acceptance.',
          ],
        ),
        _PolicySection(
          '2. Eligibility & Account',
          [
            'You must be at least 18 years old to use AutoApply. By registering, you represent that all information you provide is accurate and that you are authorised to enter into this agreement.',
          ],
          bullets: [
        ...
        _PolicySection(
          '3. Permitted Use',
          [
            'AutoApply is a job-discovery and application-assistance tool for individual job seekers. You may use it solely for personal, non-commercial job-search purposes.',
          ],
          bullets: [
        ...
        _PolicySection(
          ...
          bullets: [
            'Scraping, harvesting, or bulk-downloading data from AutoApply or third-party sites via the Service.',
            'Using the Service to submit applications on behalf of other individuals.',
            'Reverse-engineering, decompiling, or creating derivative products from AutoApply.',
        ...
        _PolicySection(
          ...
          [
            'AutoApply offers a Free plan and a Pro plan. Pro plans are available on monthly or yearly billing cycles.',
          ],
          bullets: [
        ...
        _PolicySection(
          ...
          [
            'AutoApply uses large language models (Azure OpenAI) to generate resume suggestions, job scores, and autofill answers. You acknowledge that:',
          ],
          bullets: [
            ...
            'AutoApply does not guarantee that AI suggestions will improve your job-search outcomes.',
          ],
        ),
        _PolicySection(
          '8. Third-Party Job Listings',
          [
            'AutoApply surfaces job listings scraped from publicly available company career pages. We are not responsible for the accuracy, availability, or terms of any third-party job posting.',
            'Applying for a job creates a direct relationship between you and the employer. AutoApply is not party to that relationship.',
          ],
        ),
        _PolicySection(
          '9. Intellectual Property',
          [
            'All software, design, trademarks, and content on autoapplynow.in are owned by AutoApply or its licensors. You are granted a limited, non-exclusive, non-transferable licence to use the Service for personal job-search purposes.',
            'Your profile data and uploaded resume remain your property. You grant AutoApply a licence to process them solely to provide the Service.',
          ],
        ),
        _PolicySection(
          '10. Cancellations',
        ...
        _PolicySection(
          ...
          [
            'AutoApply is provided "as is" without warranties of any kind. We do not guarantee continuous, error-free service or specific job-search outcomes.',
            'To the maximum extent permitted by law, AutoApply\'s total liability to you for any claim arising from your use of the Service shall not exceed the amount you paid us in the 30 days preceding the claim.',
          ],
        ),
        _PolicySection(
          '12. Governing Law',
    ...
    return _PolicyScaffold(
      ...
      sections: const [
        _PolicySection(
          ...
          [
            'All payments made to AutoApply are final and non-refundable.',
        ...
        _PolicySection(
          ...
          [
            'AutoApply provides immediate access to AI-powered features upon payment. Because the full value of the subscription (unlimited job searches, AI autofill, resume tailoring) is made available instantly and is consumed progressively, we are unable to recover that value once granted.',
